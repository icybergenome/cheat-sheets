...
--------|---------|----|-------------------------
 Clones a repository into a newly created directory| git-clone | -l, -s URL:https://git-scm.com/docs/git-clone 
...
Stash the changes in a dirty working directory away|  git-stash  | pop,apply,branch URL:https://git-scm.com/docs/git-stash
